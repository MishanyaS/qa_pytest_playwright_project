...
class TestAuthentication:
    ...
    @allure.description("Verifies that a valid username and password return a successful authentication response containing a valid token.")
    @pytest.mark.smoke
    ...
    @allure.description("Verifies that authentication with invalid credentials returns the expected Bad credentials response.")
    @pytest.mark.negative
    def test_create_auth_token_with_invalid_credentials(self, auth_client: AuthClient) -> None:
        with allure.step("Create authentication token"):
