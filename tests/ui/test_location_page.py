...
class TestLocationPage:
    ...
    @allure.description(
        "Verifies that the Location section can be open from the Home page and contains the expected title and description."
    )
    @pytest.mark.smoke
    ...
    def test_location_section_opens(self, page: Page) -> None:
        ...
        with allure.step("Verify Location description"):
            assert (
                location_page.get_location_description()
                == "Find us in the beautiful Newingtonfordburyshire countryside"
            )
    ...
    @allure.description(
        "Verifies that the Location section contains a visible map and location marker."
    )
    @pytest.mark.positive
    ...
    @allure.description(
        "Verifies that the Location section displays the expected address, phone number and email address."
    )
    @pytest.mark.smoke
    @pytest.mark.positive
    def test_contact_information_is_displayed(self, page: Page) -> None:
        ...
        with allure.step("Verify Contact Information title"):
            assert (
                location_page.get_text(location_page.contact_information_title)
                == "Contact Information"
            )

        with allure.step("Verify address"):
            assert (
                location_page.get_address()
    ...
    @allure.description(
        "Verifies that the Getting Here section contains the expected title and description.."
    )
    @pytest.mark.positive
    def test_getting_here_information_is_displayed(self, page: Page) -> None:
        ...
        with allure.step("Verify Getting Here description"):
            assert (
                location_page.get_getting_here_description()
